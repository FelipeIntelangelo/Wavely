...
public class SecurityConfig {
        ...
        // Proveedor de autenticación que conecta al servicio de usuarios y al
        // codificador
        @Bean
                ...
                return http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                .requestMatchers("/podcastUTN/v1/auth/login",
                                                                "/podcastUTN/v1/auth/google")
                                                .permitAll()
                                                .requestMatchers(HttpMethod.GET, // Agregar todos los GET que se
                                                                                 // permitan sin autenticación
                                                                ...
                                                                "/podcastUTN/v1/recommendations/dice")
                                                .permitAll()
